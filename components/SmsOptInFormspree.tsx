...
type SmsOptInFormspreeProps = {
  formspreeEndpoint: string; // ex: "https://formspree.io/f/xxxxxx"
  directLink?: string; // ex: "https://www.pawfectstrolls.com/privacy-policy#sms-optin"
};

type ModalState =
  | { open: false; type: "success" | "error"; title: string; message: string }
